...
def baliho():
	try:
		...
		print ' ' + W
		print ('TYPE"help" FOR ALL COMMAND').center(44)
		print (W + '     [' + G +'FB-TOOLS BY 4HS4N.HAXOR'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    Author     4HS4N.HAXOR
    Name       Facebook Information Tools By 4HS4.HAXOR
    Version    Full Version
    Date       13/08/2018 
    Gmail      ahasunofficial618@gmail.com
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   token              Generate access token ( First You Need Access Token )
